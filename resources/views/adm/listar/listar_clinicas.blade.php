...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item col-sm-12 col-md-2 col-lg-2  mt-3">
        <a class="nav-link active " id="lista1-tab" data-toggle="tab" href="#lista1" role="tab" aria-controls="lista" aria-selected="true">Clínicas</a>
    </li>
</ul>
...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="lista1" role="tabpanel" aria-labelledby="lista1-tab">
        <div style="background-color: white;">
            <h3 class="ml-2 pt-3">Lista de Clínicas </h3>
            <div class="row ml-4">
